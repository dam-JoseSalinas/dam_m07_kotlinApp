...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.bottomNavigationView.setOnItemSelectedListener {
            when(it.itemId) {
                R.id.home_button -> replaceFragment(HomeFragment())
                R.id.selected_button -> replaceFragment(SelectedFragment())
                R.id.personal_button -> replaceFragment(PersonalFragment())
                else -> {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when(item.itemId) {
            R.id.shop_zone -> replaceFragment(ShopFragment())
            R.id.chat_zone -> replaceFragment(ChatFragment())
            R.id.wiki_zone -> replaceFragment(WikiFragment())
        }
